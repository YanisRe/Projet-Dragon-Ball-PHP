...
class Heros extends Personnage{
    ...
    $hero1 = new Heros("Goku", 100, 20, 10, $vilain);
    $hero2 = new Heros("Vegeta", 100, 20, 10, $vilain);
    $hero3 = new Heros("Gohan", 100, 20, 10, $vilain);
    $hero4 = new Heros("Trunks", 100, 20, 10, $vilain);
    $hero5 = new Heros("Goten", 100, 20, 10, $vilain);
    $hero6 = new Heros("Piccolo", 100, 20, 10, $vilain);
    $hero7 = new Heros("Krilin", 100, 20, 10, $vilain);
    $hero8 = new Heros("C-18", 100, 20, 10, $vilain);
    $hero9 = new Heros("Tenshinhan", 100, 20, 10, $vilain);
    $hero10 = new Heros("C-17", 100, 20, 10, $vilain);
